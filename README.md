# 🛒 EasyTech Pro - Complete E-Commerce Solution
...
![EasyTech Pro Preview](./public/preview.png)
...
```bash
git clone https://github.com/noorjsdivs/EasyTechpro-yt
cd EasyTechpro
```
...
NEXT_PUBLIC_COMPANY_NAME=EasyTech
NEXT_PUBLIC_COMPANY_EMAIL=support@EasyTech.com
...
3. Create a new project:
   ```bash
   npm create sanity@latest -- --env=.env --create-project "EasyTech Pro" --dataset production
   ```
